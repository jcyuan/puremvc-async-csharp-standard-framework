...
namespace PureMVC.Patterns.Observer
{
    ...
    public class ObserverAsync : IObserverAsync
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        public ObserverAsync(Func<INotification, Task> notifyMethod, object notifyContext)
        {
        ...
        public virtual async Task NotifyObserverAsync(INotification notification)
        {
            await NotifyMethod(notification);
        }
        ...
        public Func<INotification, Task> NotifyMethod { get; set; }
